...
describe("sandbox adapter execution targets", () => {
  ...
  it("keeps adapter command paths ahead of the queue curl shim and inherited system paths", async () => {
    const executionTarget = await import("./execution-target.js");
    const mergeBridgeEnv = (executionTarget as {
    ...
    expect(mergeBridgeEnv).toEqual(expect.any(Function));
    if (typeof mergeBridgeEnv !== "function") return;
